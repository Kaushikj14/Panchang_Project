    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                ...
                <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis assumenda illo tempore et quae velit atque voluptatibus exercitationem eius animi debitis hic, consequuntur, blanditiis est neque mollitia molestias? Nulla, commodi?</p>
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">Panchang</a> 2024, All rights reserved.</span>
                <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    <a href="https://www.youtube.com/"  class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
